...
class HomeController extends Controller
{
    ...
    public function profile(): View
    {
        $user = [
            ...
            "github" => "github.com/Isvane",
            "major" => "Teknik Informatika",
            "semester" => 4,
            "status" => "Aktif",
            "avatar_url" =>
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiWVPFrCTsmAXmispNJpm9PCmkiJhdz_aR6ixbi9pcpLVXuPL_3LaK0To4EMhdPQScgik52ysU6fmkmw5y-zBCfRWGGfmyvvBFyYreF_sfKiVCLw2vJmJBgo1vZ-uvDOM&s=10&ec=121630504",
        ];
